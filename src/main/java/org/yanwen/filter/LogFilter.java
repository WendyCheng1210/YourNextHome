...
public class LogFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        String logInfo = logInfo(req);//These 3 lines is for preprocessing
//        logger.info("I am in logger filter preprocessing");

        filterChain.doFilter(request, response);//postprocessing
//        logger.info("I am in logger filter post postprocessing");
